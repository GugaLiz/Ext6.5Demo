...
Ext.define('Fleet5.ux.toggle.ToggleSlide', {
    ...
    */
    ...
    // private
    dragging: false,
    componentCls: 'x-toggle-slide-22 x-toggle-slide-container',
    disabledCls: 'x-toggle-slide-disabled',

    initComponent: function () {
        Fleet5.ux.toggle.ToggleSlide.superclass.initComponent.call(this);
        this.addEvents(
        /**
        * @event beforechange
    ...
    */
    onRender: function (ct, position) {
        Fleet5.ux.toggle.ToggleSlide.superclass.onRender.call(this, ct, position);
        ...
        if (!this.disabled) {
            ...
            Fleet5.ux.toggle.ToggleSlide.superclass.disable.call(this);
        }
    },
    ...
    */
    enable: function () {
        if (this.disabled) {
            Fleet5.ux.ToggleSlide.superclass.enable.call(this);
            this.registerToggleListeners();
        }
