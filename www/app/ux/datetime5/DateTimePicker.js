Ext.define('Fleet5.ux.datetime5.DatetimePicker', {
    ...
    changeTimeValue: function (slider, e, eOpts) {
        ...
        if (me.pickerField && me.pickerField.getValue) {
            me.pickerField.setValue(new Date(me.pickerField.getValue().setHours(
                me.hourSlider.getValue(),
                me.minuteSlider.getValue(),
                me.secondSlider.getValue())));
        } else {
            me.pickerField.setValue((new Date()).setHours(
                me.hourSlider.getValue(),
                me.minuteSlider.getValue(),
                me.secondSlider.getValue()));
        }
