...
Ext.define('Fleet5.ux.dd.CellFieldDropZone', {
    ...
    init: function (grid) {
        ...
        if (grid.rendered) {
            ...
            grid.getView().on({
                render: function (v) {
                    me.view = v;
                    Fleet5.ux.dd.CellFieldDropZone.superclass.constructor.call(me, me.view.el);
                },
                single: true
            });
        } else {
    ...
    onNodeDrop: function (target, dd, e, dragData) {
        if (this.dropOK) {
            this.onCellDrop(target, target.record, dragData);
            return true;
        }
    },
