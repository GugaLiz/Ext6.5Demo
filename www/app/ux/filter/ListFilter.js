 ...
 *
 */
Ext.define('Fleet5.ux.filter.ListFilter', {
...
filter : [{"type":"list","value":"small,medium","field":"size"}]
    ...
    createMenu: function(config) {
        var menu = Ext.create('Fleet5.ux.menu.ListMenu', config);
