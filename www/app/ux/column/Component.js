...
Ext.define('Fleet5.ux.column.Component', {
    alias: 'widget.uxcomponentcolumn',
    extend: 'Ext.grid.column.Column',
    requires: ['Fleet5.ux.column.CTemplate'],
    ...
    */
    ...
    calculateFrameWidth: function (component) {
        ...
        if (parentTd) {
            ...
            if (parentDiv.getFrameWidth) {
                this.lastFrameWidth = parentDiv.getFrameWidth('lr') + parentTd.getFrameWidth('lr');
            } else {
                this.lastFrameWidth = parentDiv.getPadding('lr') + parentTd.getPadding('lr');
            }
    ...
    createTemplate: function (tpl) {
        return tpl && tpl.isTemplate ?
            tpl :
            Ext.create('Fleet5.ux.column.CTemplate', tpl || ['{', this.dataIndex, '}']);
    },
