 ...
 * @markdown
 */
Ext.define('Fleet5.ux.FiltersFeature', {
    extend: 'Ext.grid.feature.Feature',
    alias: 'feature.filters',
    uses: [
        'Fleet5.ux.menu.ListMenu',
        'Fleet5.ux.menu.RangeMenu',
        'Fleet5.ux.filter.BooleanFilter',
        'Fleet5.ux.filter.DateFilter',
        'Fleet5.ux.filter.ListFilter',
        'Fleet5.ux.filter.NumericFilter',
        'Fleet5.ux.filter.StringFilter'
    ],
